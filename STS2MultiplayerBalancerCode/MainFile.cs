...
//You're recommended but not required to keep all your code in this package and all your assets in the STS2MultiplayerBalancer folder.
[ModInitializer(nameof(Initialize))]
public partial class MainFile : Node
{
    public const string
        ModId = "STS2MultiplayerBalancer"; //At the moment, this is used only for the Logger and harmony names.
